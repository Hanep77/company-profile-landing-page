...
export default function Navbar() {
    return (
        <nav className="absolute top-0 w-full h-28 text-slate-100">
            <div className="max-w-screen-xl px-4 flex justify-between h-full items-center m-auto">
                ...
                <button className="border-2 border-orange-800 px-4 py-1 rounded-full hover:bg-orange-800">Let&#39;s talk</button>
            </div>
        </nav>
    )
}